...
const TopBar = () => {
    ...
    const { bothPlayersReady, lockOtherPlayerBoard, showDcModal, gameOverMsg, usersCounter } = useContext(BsContext);
    ...
    return (
        <TopBarWrapper>
                ...
                {bothPlayersReady && !gameOverMsg ? <TurnHolder myturn={!lockOtherPlayerBoard}>{!lockOtherPlayerBoard ? <TurnText><Flash>Its Your Turn!</Flash></TurnText> : <TurnText>Opponent Turn<Loader style={{ paddingLeft: '0.5vw', position: 'relative', top: '1.1vw' }} type="ThreeDots" color="white" height={'4vw'} width={'4vw'} /> </TurnText>}
                </TurnHolder> : ' '}
